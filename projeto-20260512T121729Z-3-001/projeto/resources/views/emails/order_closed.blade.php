...
<body style="font-family: 'Outfit', 'Inter', sans-serif; background-color: #f8fafc; margin: 0; padding: 2rem; color: #1e293b;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        ...
        <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 2.5rem; text-align: center; border-bottom: 4px solid #10b981;">
            ...
            <p style="color: #94a3b8; margin: 0.5rem 0 0; font-size: 0.95rem; font-weight: 500;">A sua encomenda já foi enviada!</p>
        </div>
        
        <!-- Content -->
        <div style="padding: 2.5rem;">
            <p style="font-size: 1rem; line-height: 1.6; margin: 0 0 1.5rem;">Olá, <strong>{{ $order->customer->user->name }}</strong>,</p>
            <p style="font-size: 1rem; line-height: 1.6; margin: 0 0 1.5rem;">Temos o prazer de informar que a sua encomenda <strong>#{{ $order->id }}</strong> foi processada e enviada! A sua t-shirt personalizada já se encontra a caminho da morada indicada.</p>
            
            <p style="font-size: 1rem; line-height: 1.6; margin: 0 0 1.5rem;">Anexado a este e-mail, encontrará o seu **recibo de faturação em formato PDF**. Poderá também descarregá-lo a qualquer momento através do seu histórico de encomendas na nossa loja online.</p>

            <!-- Details Box -->
            <div style="background-color: #f1f5f9; border-radius: 8px; padding: 1.5rem; margin-bottom: 2rem; border: 1px solid #e2e8f0;">
                <h3 style="margin-top: 0; color: #0f172a; font-size: 1rem; font-weight: 700; border-bottom: 1px solid #cbd5e1; padding-bottom: 0.5rem;">Resumo da Encomenda</h3>
                <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem; line-height: 1.6;">
                    <tr>
                        <td style="color: #64748b; font-weight: 600; padding: 0.25rem 0;">Data de Envio:</td>
                        <td style="color: #0f172a; font-weight: 700; text-align: right; padding: 0.25rem 0;">{{ date('Y-m-d') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr style="border-top: 1px solid #cbd5e1;">
                        <td style="color: #0f172a; font-weight: 700; padding: 0.75rem 0 0;">Total da Compra:</td>
            ...
            <p style="font-size: 1rem; line-height: 1.6; margin: 0 0 1.5rem;">Agradecemos sinceramente a sua preferência pela FunShirt e esperamos que goste da sua nova t-shirt!</p>

...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="background: white; padding: 2.5rem; border-radius: var(--radius); border: 1px solid var(--border); box-shadow: var(--shadow);">
        ...
        <h2 style="font-size: 1.875rem; font-weight: 800; margin-bottom: 0.5rem; color: var(--primary);">Editar Utilizador</h2>
        <p style="color: var(--text-muted); margin-bottom: 2rem;">Atualize as informações do utilizador administrativo ou funcionário.</p>

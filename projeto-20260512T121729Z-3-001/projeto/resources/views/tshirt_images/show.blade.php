...
<div class="container" style="padding-top: 2rem; padding-bottom: 4rem;">
    <a href="{{ route('home') }}" style="display: inline-flex; align-items: center; text-decoration: none; color: var(--secondary); font-weight: 600; margin-bottom: 2rem; transition: color 0.2s;" onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color='var(--secondary)'">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: start;">
        ...
        <!-- Detalhes -->
        <div>
            <span style="display: inline-block; padding: 0.25rem 0.75rem; background: #f1f5f9; color: var(--secondary); border-radius: 99px; font-size: 0.875rem; font-weight: 700; text-transform: uppercase; margin-bottom: 1rem;">
            ...
            <div style="margin-bottom: 2.5rem;">
                <span style="font-size: 2.5rem; font-weight: 800; color: var(--primary);">
                    {{ number_format($tshirtImage->customer_id ? $price->unit_price_own : $price->unit_price_catalog, 2) }}€
                </span>
                <span style="display: block; font-size: 0.875rem; color: #94a3b8; margin-top: 0.25rem;">IVA incluído</span>
            </div>

            <form action="{{ route('cart.add', $tshirtImage) }}" method="POST">
                @csrf

                <!-- Inputs Escondidos para as opções Custom da Estampa -->
